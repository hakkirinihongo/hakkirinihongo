---
title: "てみせる (te miseru): significato e uso nella grammatica giapponese"
subtitle: "Come si forma e come si usa てみせる per mostrare concretamente un’azione, rendere evidente un risultato ed esprimere volontà o determinazione"
description: "Che cosa significa てみせる (te miseru) e come si usa? Formazione, rapporto con 見せる, uso letterale e grammaticale, sfumature di dimostrazione e determinazione, con esempi."
...
Che cosa significa davvero てみせる in giapponese e come si usa?



In giapponese, てみせる (temiseru) presenta un’azione **come qualcosa che viene compiuto deliberatamente e reso evidente agli altri**. 

A seconda del contesto, può indicare: 

- una dimostrazione concreta; 
- la manifestazione esteriore di un atteggiamento o di una reazione; 
- la ferma determinazione a raggiungere un risultato: in altre parole, «lo farò e dimostrerò di esserne capace».


La struttura てみせる è interessante perché sta a metà tra lessico e grammatica. 

Da un lato viene dal verbo 見せる, che nei dizionari è definito come *“far vedere”*, *“mostrare”* e anche *“far capire agli altri attraverso comportamento, atteggiamento o espressione”*; dall’altro, lo stesso verbo ha anche un uso ausiliare dopo la forma in -て, dove i dizionari registrano due valori principali: **mostrare concretamente un’azione facendola davvero** e **esprimere una forte decisione**. 

Mentre il primo è sostanzialmente un uso letterale del verbo 見せる (ossia si lega al verbo che lo precede a mezzo della forma in -te e il significato non si discosta dall'idea concreta di mostrare qualcosa a qualcuno), il secondo uso ha una forte componente volitiva ed è idiomatico.
...
Abbiamo deciso di illustrare l'uso di みせる come verbo ausiliare, non tanto perché non venga spiegato nelle grammatiche o nei manuali, quanto piuttosto perché vi sono dei punti che raramente vengono trattati o approfonditi e questo può generare confusione e difficoltà di interpretazione da parte dello studente che incontra questa struttura.
...
In questo uso la componente visiva non sparisce del tutto: diventa più astratta, quasi sociale o psicologica. Non si tratta di **“rendere qualcosa letteralmente visibile”**, ma di far risultare evidente la propria capacità, volontà o determinazione. 
...
**Approfondimento**: Un modo utile per precisare la funzione di てみせる è confrontarla con i [verbi composti in ～込む](/articoli/verbo-ausiliare-komu-giapponese-significato-uso/). In entrambi i casi troviamo un verbo originariamente autonomo che, combinandosi con un altro verbo, conserva una parte della propria immagine lessicale e assume al tempo stesso una funzione più astratta. I due meccanismi, tuttavia, operano su livelli diversi.

～込む tende a modificare il profilo interno dell’evento. 読む diventa 読み込む e passa dalla semplice idea di “leggere” a quella di “leggere attentamente”, “studiare a fondo”, “assimilare” o, nel linguaggio informatico, “caricare dei dati”.

てみせる, invece, non intensifica necessariamente l’azione in sé. Aggiunge piuttosto la prospettiva di qualcuno davanti al quale l’azione o il suo risultato vengono mostrati, resi evidenti o presentati come prova. 読む diventa così 読んでみせる: non semplicemente “leggere”, ma “leggere facendolo vedere”, oppure “dimostrare di saperlo o poterlo leggere”.

La distinzione emerge con particolare chiarezza quando le due forme compaiono insieme:

* 読む → 読み込む: l’azione acquista profondità o completezza;
* 読み込む → 読み込んでみせる: l’intera azione viene presentata come dimostrazione, promessa o prova della determinazione del soggetto.

In 読み込んでみせる, dunque, てみせる non si collega direttamente al semplice 読む, ma prende come proprio contenuto il composto già formato 読み込む.

Questo confronto mostra perché てみせる non dovrebbe essere interpretato come un generico intensificatore. 

L’intensità o la profondità possono essere già espresse dal verbo precedente oppure da elementi come ～込む; ciò che てみせる aggiunge è diverso: attribuisce all’azione una direzione esterna, interpersonale e dimostrativa, facendo sì che il suo svolgimento o il suo risultato acquistino il valore di qualcosa che viene mostrato, riconosciuto o provato davanti agli altri.
...
Qui l'uso di てみせる è assolutamente corretto, perché si sta esprimendo un forte intento riguardo a qualcosa di non ancora realizzato e ci si accinge a **dimostrare** che tale obiettivo verrà raggiunto.
...
Questa è da ritenersi a tutti gli effetti errata o comunque poco naturale, poiché non si sta esprimendo una forte predisposizione verso un intento futuro, ma è un goffo tentativo di *"raccontare"* un'azione passata che si è riusciti a portare a compimento. 

Verrebbe però in questo caso a mancare il vero senso di てみせる con uso idiomatico/volitivo, ossia esprimere forte determinazione verso qualcosa ancora da realizzare.
...
E sarebbe errato, poiché come vedremo, l'uso letterale/lineare di てみせる (dare dimostrazione di…) è circoscritto a contesti e verbi che descrivono azioni pratiche. E *"diventare il presidente di un'azienda"*, certamente non lo è: *"ho dato dimostrazione pratica di poter diventare il presidente di questa azienda"*, non è grammaticalmente errato, ma è abbastanza brutto e suona davvero strano. No?
...
野崎さんは、この会社の社長になってみせる。 - *"Nozaki-san dimostrerà (perché ha una forte volontà di riuscirci) di poter diventare il presidente di questa società."*
...
僕は小説を書いてみせる。- *"Sono determinato a scrivere un romanzo."*

今年こそ、修士論文を書き上げてみせる。- *"Proprio quest'anno, ho la determinazione per finire di scrivere la mia tesi."*

三百ページの本を一時間で読んでみせる。 - *"Sono determinato a dimostrare che posso leggere 300 pagine del libro in un'ora."* *(Non voglio dare una dimostrazione pratica, ma voglio dimostrare di poterci riuscire)*.


Ricapitolando, una corretta scelta del verbo e l'obiettivo da raggiungere che è descritto nella proposizione, unitamente al tempo non passato e all'uso della prima persona, determinano da un lato, un uso corretto della sfumatura volitiva てみせる da parte del parlante; mentre invece il saper riconoscere questi elementi determina dall'altro lato una corretta capacità di comprensione da parte di chi ascolta o legge.
...
一郎は百メートルを十一秒で走ってみせた。- *"Ichirō, ha dato dimostrazione di poter correre i 100 metri in 11 secondi"*.
...
Dunque, si tratta di azioni più concrete e, come vedremo negli esempi riepilogativi, spesso anche dell’idea di far vedere a qualcuno come fare qualcosa.

Nell'impiego letterale di てみせる, anche il rivolgersi a una seconda persona o parlare di una terza persona, al tempo non passato, acquistano (in alcuni casi) un senso più *"accettabile"*.

Esempi:

百メートルを十一秒で走ってみせますか - *"Dimostrerai (mostrerai) che puoi correre i 100 metri in 11 secondi?"*

一郎は百メートルを十一秒で走ってみせます - *"Ichirō darà dimostrazione di poter correre i 100 metri in 11 secondi."*
...
Ad ogni modo, ciò che è importante ricordare è che queste ultime due (terza persona e forma interrogativa) sono possibili in questo caso, proprio perché てみせる, come abbiamo visto, se usato in certi contesti e con la scelta dei verbi appropriati, mantiene il suo **significato forte e primario** di *"mostrare"*, *"far vedere"* e non di *"dimostrare".*
...
*"L’insegnante ha pronunciato correttamente la parola per mostrarla agli studenti."*

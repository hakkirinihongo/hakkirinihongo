...
Quali sono le differenze tra 気分 (kibun), 調子 choushi, 体調 (taichou) e 具合 (guai)?
...
Di seguito spiegheremo questi vocaboli partendo dall'analisi dei kanji che li compongono e il loro uso tipico nel linguaggio quotidiano (inclusi aspetti di salute medica), con esempi in giapponese e traduzione. 
...
Nell’ultimo esempio, 気分が悪かった indica un malessere fisico generico, spesso nausea da mal d’auto. 

In un contesto medico, una persona potrebbe dire al dottore 昨夜から気分が悪いです per indicare che si ha la nausea o un senso di malessere generale. Invece, per **“buon umore”** in senso mentale, si userà solo 気分がいい.
...
Invece si usa 調子 per parlare di umore: ad esempio “essere di buon umore” è 気分がいい, non 調子がいい, a meno che si intenda *“essere in forma / andare tutto bene”*.
...
In contesti  medici o quotidiani riguardanti la salute, 具合 è molto usato. Ad esempio, un dottore o un familiare può chiedere: 具合はどうですか? (*Come ti senti?*), riferito a una persona malata. Oppure si dice 食後の具合 (*come ci si sente dopo aver mangiato*). 
...
Se però c’è rischio di fraintendimento, spesso si specifica 体の具合 per **parlare di salute** e 都合per **parlare di convenienza**.
...
具合 infatti vale sia per persone che cose, e 調子 lo stesso, mentre 体調 è esclusivo delle persone e 気分 riguarda solo stati d’animo o sensazioni fisiche soggettive. 
...
Questi vocaboli si sovrappongono in buona parte quando parliamo in generale di stare bene/male fisicamente. Ad esempio 体調が悪い, 具合が悪い e 調子が悪い possono esprimere in modo simile il fatto di non essere in buona forma. 

Tuttavia, ciascuna ha  contesti privilegiati:

---
title: "Distinguere tra 気分 (kibun), 調子 (choushi), 体調 (taichou) e 具合 (guai)"
subtitle: "Quattro parole giapponesi che esprimono stato d'animo, condizione fisica, ritmo e funzionamento."
description: "Differenza tra 気分, 調子, 体調 e 具合: analisi delle sfumature semantiche e criteri di scelta nel giapponese contemporaneo (JLPT N3)."
...
Molti studenti di giapponese confondono 気分, 調子, 体調 e 具合 perché tutte possono essere tradotte con “stato” o “condizione”.

La differenza tra 気分, 調子, 体調 e 具合 riguarda il tipo di “stato” che si descrive.
Sebbene in italiano queste parole vengano spesso tradotte con termini simili — stato, condizione, forma, sensazione — in giapponese si riferiscono a ambiti diversi e non sono sempre intercambiabili.

In sintesi:

気分 (きぶん) → stato emotivo o sensazione soggettiva di una persona

調子 (ちょうし) → ritmo o funzionamento generale (di una persona o di qualcosa)

体調 (たいちょう) → condizione fisica del corpo e stato di salute

具合 (ぐあい) → stato o condizione di qualcosa, in senso molto ampio

La differenza fondamentale dipende quindi dall’ambito a cui si riferisce lo “stato”: emotivo, funzionale, fisico oppure generale.
...
Qual è la differenza tra 気分, 調子, 体調 e 具合?
Come è stato già accennato nell'introduzione, nel giapponese troviamo diversi termini per indicare **"come ci si sente"** o la condizione  di una persona (o di una cosa), e può essere difficile distinguerli. 
In particolare, 気分(kibun), 調子 (chōshi), 体調 (taichō) e 具合 (guai) hanno sfumature diverse tra loro. 
Di seguito spiegheremo questi vocaboli e lo faremo attraverso quello che riteniamo essere il miglior approccio possibile, ossia partendo dall'analisi dei kanji che li compongono e il loro uso tipico nel linguaggio quotidiano (inclusi aspetti di salute medica), con esempi in giapponese e traduzione. Infine faremo un  confronto  per capire quando sono intercambiabili e quando non lo sono.
...
Possiamo pensare a 調子 come a qualcosa che indica il “tono” o l’accordatura (come in musica) e il modo in cui qualcosa “suona” o funziona. In altre parole, rappresenta lo stato di funzionamento o l’andamento (o il ritmo) di una persona o di un oggetto.
...
ad esempio *機械の具合 (lo stato di un macchinario)* o *体の具合 (lo stato del corpo)*. **具合が悪い** è comunemente usato per dire **“qualcosa non va”** sia in una macchina che nel proprio corpo. Esempio: *テレビの具合がおかしい* - *il televisore ha qualcosa che non va*. 
...
具合 può anche riferirsi all’aspetto o presentabilità (体裁). Ad esempio, *ここまで来て断るのは具合が悪い* significa *“ormai siamo arrivati al punto che rifiutare sarebbe una brutta figura”*. Questi usi sono più rari nel parlato quotidiano, ma esistono.
...
Quando si vuol dire “non mi sento bene” in senso fisico generale, è possibile usare **体調が悪い**, **具合が悪い** o **調子が悪い** quasi in modo intercambiabile. Ad esempio, se si telefona al lavoro per avvisare che si è malati, **今日は体調が悪いです**, **今日は具合が悪いです**  o  **今日は調子が悪い** sono tutte frasi comprensibili per dire che non si sta bene in salute. 
...
Come notato, 気分 riferito al corpo si usa per la condizione generale e non per un singolo organo o parte. 体調, dal canto suo, riguarda sempre il corpo intero. Non si dice mai 足の体調 (ad esempio se fa male una gamba si userà *具合/調子*).
...
Ad esempio: *パソコンの調子が悪い* = *“il computer funziona male”*, oppure *パソコンの具合を見る* = *“controllare come va il computer”*. 
具合 infatti vale sia per persone che cose, e 調子 lo stesso, mentre 体調 è esclusivo delle persone e 気分 riguarda solo stati d’animo o sensazioni fisiche soggettive. Tra 調子 e 具合, per i macchinari 調子 è forse più usato quotidianamente (**エンジンの調子が悪い** suona naturale).  
...
Ad esempio: **お体の具合はいかがですか？** è una frase cortese per chiedere **"Come sta di salute?"**. Oppure **ご気分はいかがですか？** può essere usato da un medico/infermiere verso un paziente per chiedere **“Come si sente?”** (qui 気分 è riferito al sentirsi fisicamente, non all’umore). 
...
気分 da solo non si usa per chiedere dello stato di salute altrui (suonerebbe più come “come va l’umore”), a meno che l’altro non abbia riferito specificamente nausea: ad esempio: **まだ気分悪い？大丈夫？**, se sapevamo che in precedenza aveva avuto la nausea.

...
きっかけ è una di quelle parole il cui uso moderno si comprende ancora meglio conoscendone l'origine storica. 

A proposito, se si ha interesse per questo aspetto dell'evoluzione del lessico giapponese, nel sito è presente anche un'approfondimento dedicato a [ご無沙汰 (gobusata)](/articoli/gobusata-origine-storia-significato-giapponese/), un'espressione risalente al **Kanbun** (漢文 lett. "scrittura degli Han", un sistema scrittorio del cinese letterario adottato in Giappone dal periodo Nara nel VIII secolo) e oggi impiegata come formula di cortesia. 

Pur appartenendo a contesti molto diversi, entrambe mostrano come numerose parole giapponesi conservino nella loro storia significati ormai non più immediatamente percepibili.


Ma tornando a きっかけ, in origine questa parola derivava dall’espressione 切り掛け（きりかけ), che indicava **il momento in cui si inizia a tagliare un materiale**. 

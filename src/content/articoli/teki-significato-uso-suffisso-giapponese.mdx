...
Cosa è il suffisso 的 (teki) e a cosa serve esattamente?  In giapponese moderno,   的 letto (てき) è soprattutto un **suffisso derivazionale di origine sino-giapponese**: si attacca in primo luogo a dei nomi e forma sostanzialmente ciò che nella grammatica tradizionale giapponese viene trattato come **tema di un [aggettivo in na](/articoli/aggettivi-na-giapponese-origine-storia/)**. Nella pratica lo si incontra infatti soprattutto in forme come 〜的な, 〜的に e, in certi contesti, 〜的だ o A的B senza な. 

...
alternateEnglish: "/en/articles/hantai-hankou-teikou-tairitsu-sakarau-difference-japanese/"
---




Cosa significa davvero e attraverso quali verbi si dice “opporsi” in giapponese?
Nel giapponese moderno esistono diversi verbi che esprimono il concetto di opposizione o resistenza. 
反対する, 反抗する, 抵抗する, 対立する, 逆らう sono cinque verbi spesso tradotti allo stesso modo, ma che in realtà descrivono forme molto diverse di opposizione. 

Dire no a un’opinione, ribellarsi a un’autorità, resistere a una pressione, trovarsi in conflitto o sfidare qualcuno: ogni verbo mette a fuoco un tipo preciso di relazione tra chi si oppone e ciò a cui si oppone.

Non sono gli unici, ma questi sono i verbi di uso più comune, nonchè quelli riscontrabili con maggiore frequenza nelle conversazioni e nelle esercitazioni di comprensione del testo, propedeutiche al JLPT.



In particolare: 

- 反対する — dire no a qualcosa: opposizione chiara e dichiarata.
- 反抗する — ribellarsi: rifiuto emotivo contro un’autorità.
- 抵抗する — resistere: opporsi a una forza che ti spinge.
- 対立する — essere in conflitto: due posizioni che si scontrano.
- 逆らう — sfidare: andare contro qualcuno, disobbedendo.




<p class="table-intro">
  Anche se tutti questi verbi esprimono l’idea di “opporsi” o “andare contro”, ciascuno descrive un tipo diverso di opposizione: disaccordo, ribellione, resistenza, conflitto o disobbedienza. La tabella seguente ne riassume le principali differenze.
</p>
  ...
  <table class="hn-table hn-table-wide">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          opposizione chiara e dichiarata<br />
          verso un’idea, una proposta<br />
          o una decisione
        </td>
        <td>
          neutro,<br />
        ...
        <td>
          ...
          Ci sono anche molte persone contrarie alla nuova legge del governo.
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          rifiuto emotivo o impulsivo<br />
          contro genitori, insegnanti,<br />
          regole o autorità
        </td>
        <td>
          più forte,<br />
        ...
        <td>
          子供が親に反抗する時期もある。<br />
          Esiste anche un periodo in cui i figli si ribellano ai genitori.
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          opposizione a una forza,<br />
          pressione o influenza<br />
          che cerca di spingerti
        </td>
        <td>
          neutro-formale,<br />
          molto usato anche per concetti astratti
        </td>
        <td>
          強い眠気に抵抗しながら勉強した。<br />
          Ho studiato resistendo a una forte sonnolenza.
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>たいりつする</td>
        <td>
          essere in conflitto,<br />
          contrapporsi
        </td>
        <td>
          due parti, idee o gruppi<br />
          sono su posizioni incompatibili<br />
          e si scontrano
        </td>
        <td>
          abbastanza formale,<br />
          frequente in testi e notizie
        </td>
        <td>
          二つの会社が利益をめぐって対立している。<br />
          Le due aziende sono in conflitto riguardo agli interessi economici.
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          non seguire un ordine,<br />
          una volontà, un superiore<br />
          o il corso naturale delle cose
        </td>
        <td>
          comune,<br />
          diretto e abbastanza forte
        </td>
        <td>
          親の意見に逆らって東京へ行った。<br />
          Sono andato a Tokyo andando contro l’opinione dei miei genitori.
        </td>
      </tr>
...
Nei paragrafi a seguire, secondo lo schema tipico adottato in questa sezione per lo studio di parole simili ma dal significato diverso, come è stato già fatto ad esempio nel confronto tra [急に,いきなり、突然](/articoli/kyuu-ni-ikinari-totsuzen-differenza-grammatica-giapponese/) o [準備, 用意, 支度](/articoli/differenza-junbi-youi-shitaku/), partendo dall'analisi dei kanji con cui i verbi sono scritti, ne verranno illustrate le sfumature, gli usi tipici e fornite frasi di esempio, per poi confrontare le sottili differenze di sfumatura tra questi termini e capire quali siano intercambiabili (o meno) in vari contesti.
...
Le sfumature tra questi verbi mostrano come il giapponese distingua finemente tra diversi tipi di relazione e tensione.

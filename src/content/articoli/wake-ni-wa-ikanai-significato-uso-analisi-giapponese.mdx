...
Nei prossimi paragrafi analizzeremo わけにはいかない passo dopo passo: partiremo dal significato generale della costruzione, ne esamineremo la formazione e la struttura grammaticale, scomporremo ogni elemento per comprenderne il ruolo specifico e vedremo poi come tutte le parti cooperano nel produrre il senso di impossibilità morale, sociale o situazionale tipico di questa espressione.
Vedremo quanto c'è di lineare e idiomatico nel costruzione, per poi chiudere con gli esempi d'uso e le consuete conclusioni.
...
Se una persona non sa nuotare, non usa questa costruzione per dire che non può nuotare; per esprimere quell'idea, serviranno appunto espressioni più consone, come 泳げない o 泳ぐことができない. 
...
Per questo わけ compare frequentemente in costruzioni che esprimono conclusioni, spiegazioni e valutazioni come　[わけではない](/articoli/wake-dewa-nai-significato-analisi-grammaticale/), わけだ, わけがない e わけにはいかない.
...
Il passaggio dal significato lessicale di 訳 alla sua funzione grammaticale è approfondito nell’articolo [訳: significato, origine, letture e uso nella grammatica giapponese](/articoli/kanji-wake-origine-storia-significato-strutture-grammaticali/).
...
Non dimentichiamoci che difficilmente un giapponese si espone in prima persona per dire cosa una terza persona pensa, prova oppure in come in questo caso, cosa può fare o non fare qualcun altro. Questo lo abbiamo già visto in costruzioni come [てみせる](/articoli/te-miseru-significato-uso-giapponese/) e tante altre ne vedremo.

...
In a broader and more detailed comparison that will include not only these two forms but also [ことにはならない (koto ni wa naranai)](/en/articles/koto-ni-wa-naranai-meaning-usage-japanese-grammar/), we will return to the topic in a future article.

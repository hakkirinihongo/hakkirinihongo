...
The comparison with [とは限らない (to wa kagiranai)](/en/articles/to-wa-kagiranai-meaning-grammar-dissection-japanese/), a structure with a similar meaning, has already been briefly touched upon in the article dedicated to that form. However, we will return to this topic in a dedicated article entirely focused on comparing all those expressions that convey the idea of *"it does not mean that..."*, including [ことにはならない (koto ni wa naranai)](/en/articles/koto-ni-wa-naranai-meaning-usage-japanese-grammar/) and *というものでもない*.

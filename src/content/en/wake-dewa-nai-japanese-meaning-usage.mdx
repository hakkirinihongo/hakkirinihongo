...
The comparison with [とは限らない (to wa kagiranai)](/articoli/to-wa-kagiranai-dissezione-grammaticale/), a form with a similar meaning, has already been touched on in the article dedicated to とは限らない, but we will return to this point in a specific article entirely dedicated precisely to the comparison of all those forms that express the idea of *"it doesn’t mean that.."*, which will also include [ことにはならない (koto ni wa naranai)](/articoli/koto-ni-wa-naranai-grammatica-giapponese/).

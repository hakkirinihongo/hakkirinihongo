...
In the following sections, we will examine わけにはいかない step by step. We will begin with its overall meaning, then look at its formation and grammatical structure, break down each component to understand the role it plays, and finally see how all the parts work together to produce the sense of moral, social, or situational impossibility that characterizes this expression.

We will also consider which aspects of the construction are compositionally transparent and which are more idiomatic, before concluding with usage examples and the usual final remarks.
...
The development of 訳 from a lexical noun into a grammatical element is explored in greater depth in the article [訳: Meaning, Origin, Readings, and Use in Japanese Grammar](/en/articles/wake-kanji-meaning-origin-readings-japanese-grammar/).

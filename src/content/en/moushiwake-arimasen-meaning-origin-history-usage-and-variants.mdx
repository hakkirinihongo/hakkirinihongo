...
The meaning of 訳 in 申し訳 is closely connected to its other uses: it still evokes the idea of a reason, explanation, or underlying logic that makes a situation understandable and justifiable.

In 申し訳ない, however, 訳 retains its lexical meaning and forms part of the compound noun 申し訳; it does not function as the grammatical element found in constructions such as [わけにはいかない (wake ni wa ikanai)](/en/articles/wake-ni-wa-ikanai-meaning-usage-japanese-grammar/) or [わけではない (wake dewa nai)](/en/articles/wake-dewa-nai-japanese-meaning-usage/).

For a more detailed discussion of the kanji’s original meaning and the process by which わけ also developed grammatical functions, see the article [訳 (わけ, wake): Meaning, Origin, Readings, and Use in Japanese Grammar](/en/articles/wake-kanji-meaning-origin-readings-japanese-grammar/).
...
The NINJAL in fact describes a perceived progression in politeness from 申し訳ない to 申し訳ありません and then to 申し訳ございません.
